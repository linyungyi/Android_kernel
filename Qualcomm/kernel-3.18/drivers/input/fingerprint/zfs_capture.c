...
/* -------------------------------------------------------------------- */
int zfs_init_capture(zfs_data_t *zfs_dev /* fpc1020 */ )
{
	zfs_dev->capture.state = ZFS_CAPTURE_STATE_IDLE; /* FPC1020_CAPTURE_STATE_IDLE */
	zfs_dev->capture.current_mode = ZFS_MODE_IDLE; /* FPC1020_MODE_IDLE */
...
/* -------------------------------------------------------------------- */
bool zfs_capture_check_ready(zfs_data_t *zfs_dev  /* fpc1020_data_t *fpc1020 */)
{
...
/* -------------------------------------------------------------------- */
int zfs1096_capture_task(zfs_data_t *zfs_dev /* fpc1020_data_t *fpc1020 */)
{
...
/* -------------------------------------------------------------------- */
int zfs1096_capture_finger_key_navi_task(zfs_data_t *zfs_dev /* fpc1020_data_t *fpc1020 */)
{
	// zfs_capture_mode_t mode = zfs_dev->capture.current_mode;
	int error = 0;
	int result = 0;
